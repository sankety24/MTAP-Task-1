...
const fetchData = (page) => {
    axios
      .get(`https://stock-server.onrender.com/products?category=cutters&_limit=12&_page=${page}`)
      .then((e) => {
        setLoading(true);
        console.log(e);
        setClothes(e.data);
        ...
        <div className='main'>
            ...
            <div className='product'>
              <div className='product-child1'>
                <p>Sale <span style={{fontSize:"12px",color:"grey",marginLeft:"10px"}}>{cloth.length} products</span></p>
